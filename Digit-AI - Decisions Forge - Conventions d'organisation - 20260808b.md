...
Statut du document : **partiel** — 2 questions de cadrage restent ouvertes (§ Ouvertes).
Indice `b` : Q1 tranchée le 2026-08-08 par D-08 à D-12, sur le cas concret du rapport
d'audit client de `forge-seo`. Version `a` archivée dans `Old/`.
