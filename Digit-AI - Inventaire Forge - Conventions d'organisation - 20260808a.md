...
|---|---|---|---|
| D1 | `ledger.jsonl` (journal append-only) | 2 | `digit-ai-forge-agents/ledger.jsonl`, `Produit-12/forge/ledger.jsonl` |
| D2 | Sidecar `<fichier>.oracles-historique.jsonl` | 2 | `digit-ai-forge-agents/output/Digit-AI - PV Forge - … - 20260723a.md.oracles-historique.jsonl`, `Produit-12/forge/RETOURS-FORGES.md.oracles-historique.jsonl` |
...
d'interface (`Afficéo/prototype/*`, 21 fichiers), sites web (`Produit-07/site`).
...
`Produit-07/input/*.html`, `CRulers/CRulers_Schema.html`.
