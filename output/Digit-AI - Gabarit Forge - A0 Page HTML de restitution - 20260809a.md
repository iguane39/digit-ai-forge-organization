# Digit-AI — Gabarit Forge — A0 « Page HTML de restitution » — 20260809a
...
(règles L1–L10 de `digit-ai-page-html/references/lisibilite.md`, contrôlées par
...
Partie 1 bis. Chaque exigence A0-13 à A0-22 est rattachée au défaut qui l'a payée.

**Internes** (test d'existence : lues sur cette machine le 08/08/2026)
- `digit-ai-page-html` — SKILL.md 1.2.0, cibles Viewer/PDF, checklist V1–V7,
  `references/lisibilite.md` (L1–L10), `scripts/self_test.py` (14 fixtures, 13 rouges)
